...
IMAGE_EDIT_PROMPT_VERSION = "generative-restoration-v1.2.0"
IMAGE_EDIT_PROMPT = """Use only the supplied advertisement image as reference.
CONTENT IS FROZEN, PLACEMENT IS NOT. Remove visible watermarks and QR codes.
Do not remove any original logo, telephone number, footer, or image motif.
Preserve aspect ratio, dimensions, logos,
