...
export const envSchema = z.object({
  ...
  PRINT_INGEST_BASE_URL: z.string().url().default("http://127.0.0.1:8010"),
  PRINT_INGEST_SERVICE_TOKEN: z.string().optional(),
  ARTWORK_BASE_URL: z.string().url().default("http://127.0.0.1:8011"),
  ARTWORK_SERVICE_TOKEN: z.string().optional(),
